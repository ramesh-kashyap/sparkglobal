...
//end fundController
  ...
  // Language Manager
Route::get('language', [App\Http\Controllers\Admin\LanguageController::class, 'langManage'])->name('language.manage');
Route::get('/language/edit/{id}', [App\Http\Controllers\Admin\LanguageController::class, 'langEdit'])->name('admin.language.key');
Route::post('/language', [App\Http\Controllers\Admin\LanguageController::class, 'langStore'])->name('admin.language.manage.store');
Route::post('/language/delete/{id}', [App\Http\Controllers\Admin\LanguageController::class, 'langDel'])->name('admin.language.manage.del');
Route::post('/language/update/{id}', [App\Http\Controllers\Admin\LanguageController::class, 'langUpdatepp'])->name('admin.language.manage.update');
Route::post('/language/import', [App\Http\Controllers\Admin\LanguageController::class, 'langImport'])->name('admin.language.import_lang');
Route::post('language/store/key/{id}', [App\Http\Controllers\Admin\LanguageController::class, 'storeLanguageJson'])->name('admin.language.store.key');
Route::post('language/delete/key/{id}', [App\Http\Controllers\Admin\LanguageController::class, 'deleteLanguageJson'])->name('admin.language.delete.key');
Route::post('language/update/key/{id}', [App\Http\Controllers\Admin\LanguageController::class, 'updateLanguageJson'])->name('admin.language.update.key');
